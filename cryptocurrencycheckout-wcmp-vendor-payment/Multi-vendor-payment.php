...
add_filter( 'automatic_payment_method', function( $wcmp_payment_methods ){
    ...
    $cc_payment_methods = array('crypto_enable' => __('Enable Cryptocurrenices ("Direct Bank Transfer" must also be enabled.) ', 'dc-woocommerce-multi-vendor'), 'crypto_btc' => __('CC Bitcoin', 'dc-woocommerce-multi-vendor'), 'crypto_ltc' => __('CC Litecoin', 'dc-woocommerce-multi-vendor'), 'crypto_eth' => __('CC Ethereum', 'dc-woocommerce-multi-vendor'), 'crypto_dash' => __('CC Dash', 'dc-woocommerce-multi-vendor'), 'crypto_arrr' => __('CC PirateChain', 'dc-woocommerce-multi-vendor'), 'crypto_znz' => __('CC Zenzo', 'dc-woocommerce-multi-vendor'),  'crypto_cds' => __('CC CryptoDeevelopmentServices', 'crypto_cdzc' => __('CC CryptoDezireCash', 'dc-woocommerce-multi-vendor'), 'crypto_send' => __('CC SocialSend', 'dc-woocommerce-multi-vendor'), 'crypto_colx' => __('CC ColossusXT', 'dc-woocommerce-multi-vendor'), 'crypto_thc' => __('CC HempCoin', 'dc-woocommerce-multi-vendor'), 'crypto_eca' => __('CC Electra', 'dc-woocommerce-multi-vendor'), 'crypto_pivx' => __('CC Pivx', 'dc-woocommerce-multi-vendor'), 'crypto_nbr' => __('CC Niobio', 'dc-woocommerce-multi-vendor'), 'crypto_gali' => __('CC Galilel', 'dc-woocommerce-multi-vendor'), 'crypto_bitc' => __('CC Bitcash', 'dc-woocommerce-multi-vendor'), 'crypto_ok' => __('CC OKcash', 'dc-woocommerce-multi-vendor'), 'crypto_ethplo' => __('CC ETHplode', 'dc-woocommerce-multi-vendor'), 'crypto_veil' => __('CC Veil', 'dc-woocommerce-multi-vendor'), 'crypto_doge' => __('CC Doge', 'dc-woocommerce-multi-vendor'));
